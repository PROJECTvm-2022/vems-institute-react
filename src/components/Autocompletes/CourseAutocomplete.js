...
import { CoursesService } from '../../apis/rest.app';
        ...
        <Autocomplete
            ...
            renderInput={(params) => (
                <TextField
                    ...
                    // margin="normal"
                    label={label ? label : Language.get('autocomplete.course.label')}
                    placeholder={placeholder ? placeholder : Language.get('autocomplete.course.placeholder')}
                    value={value}
                    variant="outlined"
                    {...params}
                    InputProps={{
