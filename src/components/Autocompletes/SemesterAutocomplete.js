...
import { SemestersService } from '../../apis/rest.app';
import { useLanguage } from '../../store/LanguageStore';

function SemesterAutocomplete({
    label,
    helperText,
    error,
    onChange,
        ...
        <Autocomplete
            ...
            renderInput={(params) => (
                <TextField
                    ...
                    // margin="normal"
                    label={label ? label : Language.get('autocomplete.semester.label')}
                    placeholder={placeholder ? placeholder : Language.get('autocomplete.semester.placeholder')}
                    value={value}
                    variant="outlined"
                    {...params}
                    InputProps={{
...
SemesterAutocomplete.propTypes = {
    id: PropTypes.string,
...
SemesterAutocomplete.defaultProps = {
    type: 'global',
    onChange: () => {},
    onSelect: () => {},
    handleClear: () => {},
