        ...
        <Autocomplete
            ...
            renderInput={(params) => (
                <TextField
                    ...
                    // margin="normal"
                    label={label ? label : Language.get('autocomplete.specialization.label')}
                    placeholder={placeholder ? placeholder : Language.get('autocomplete.specialization.placeholder')}
                    value={value}
                    variant="outlined"
                    {...params}
                    InputProps={{
