...
import { ChaptersService, UnitsService } from '../../apis/rest.app';
        ...
        <Autocomplete
            ...
            renderInput={(params) => (
                <TextField
                    ...
                    // margin="normal"
                    label={label ? label : Language.get('autocomplete.chapter.label')}
                    placeholder={placeholder ? placeholder : Language.get('autocomplete.chapter.placeholder')}
                    value={value}
                    variant="outlined"
                    {...params}
                    InputProps={{
...
ChapterAutocomplete.defaultProps = {
    type: 'global',
    onChange: () => {},
    onSelect: () => {},
    handleClear: () => {},
