...
import TakeAttendanceDialog from '../Attendance/TakeAttendanceDialog';
            ...
            <Paper className={classes.root}>
                ...
                {status !== 4 && (
                    <Button
                        ...
                        variant={'outlined'}
                    >
                        <Translate root={'institute-attendance/[id]'}>{'Join Classes'}</Translate>
                    </Button>
                )}
                ...
                {attendanceTaken !== true ? (
                    <>
                        <Button
                            ...
                            variant={'contained'}
                        >
                            <Translate root={'institute-attendance/[id]'}>{'Take Attendance'}</Translate>
                        </Button>
                    </>
                ) : (
                    <Button
