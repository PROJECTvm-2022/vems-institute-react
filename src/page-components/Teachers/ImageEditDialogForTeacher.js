...
function ImageEditDialogForTeacher({
    setOpenDialog,
    openDialog,
    each,
    position,
            ...
            <div>
                <Dialog aria-labelledby="form-dialog-title" onClose={handleClose} open={openDialog}>
                    <DialogTitle onClose={handleClose}>
                        {<Translate root={'teachers/[id]'}>{'imageInputTitle.chooseImage'}</Translate>}
                    </DialogTitle>
                    <DialogContent>
                        {image !== '' ? (
                            ...
                            >
                                ...
                                <Typography variant={'body2'}>
                                    {<Translate root={'teachers/[id]'}>{'imageInputTitle.title'}</Translate>}
                                </Typography>
                            </Box>
                        )}
                    </DialogContent>
                    <DialogActions>
                        <Button color="primary" onClick={handleClose}>
                            {<Translate root={'teachers/[id]'}>{'cancel'}</Translate>}
                        </Button>
                        <Button
                            color="primary"
                        ...
                        >
                            {loading ? (
                                ...
                                <Translate root={'teachers/[id]'}>{'upload'}</Translate>
                            )}
                        </Button>
                    </DialogActions>
                </Dialog>
