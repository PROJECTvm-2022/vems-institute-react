...
import { uploadFile, CreateUser } from '../apis/rest.app';
...
function ImageEditDialogForStudent({ setOpenDialog, openDialog, each }) {
    ...
    const [data, setData] = useStudentDetailsData();
    ...
    const handleEdit = async () => {
        ...
        setLoading(true);
        await CreateUser.patch(each?._id, {
            avatar: _logo,
        })
            .then((res) => {
                if (data) {
