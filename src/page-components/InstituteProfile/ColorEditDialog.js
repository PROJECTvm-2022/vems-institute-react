    ...
    const handleEdit = () => {
        ...
        editInstitute(each._id, {
            ...
            .then((res) => {
                ...
                setLoading(false);
                enqueueSnackbar(Language.get('successMessage.editedSuccessFully'), {
                    variant: 'success',
                });
        ...
        <>
            <Dialog fullWidth onClose={handleClose} open={colorEditor}>
                <DialogTitle onClose={() => handleClose()}>
                    {<Translate root={'institute/[id]'}>{'colorInputTitle.chooseColor'}</Translate>}
                </DialogTitle>
                <DialogContent>
                ...
                <DialogActions>
                    ...
                    <Button color={'primary'} disabled={loading} onClick={handleEdit} variant={'contained'}>
                        {loading ? (
                            ...
                            <Translate root={'institute/[id]'}>{'details.addCourse.button.update'}</Translate>
                        )}
                    </Button>
                </DialogActions>
            </Dialog>
