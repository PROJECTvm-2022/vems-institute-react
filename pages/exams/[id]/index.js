...
import { CitiesService, ExamService, StatesService } from '../../../src/apis/rest.app';
...
const ExamById = () => {
    const Language = useLanguage('exams/[id]');
                ...
                <Grid item md={12} sm={12} xs={12}>
                    <Box display="flex" justifyContent="space-between">
                        <Typography variant={'h3'}>
                            <Translate root={'exams/[id]'}>{'title'}</Translate>
                        </Typography>
                    </Box>
                </Grid>
            </Grid>
                            ...
                            <TableHead>
                                <TableRow>
                                    <TableCell align="center">
                                        <Translate root={'exams/[id]'}>{'examName'}</Translate>
                                    </TableCell>
                                    <TableCell>
                                        <Translate root={'exams/[id]'}>{'course'}</Translate>
                                    </TableCell>
                                    <TableCell>
                                        <Translate root={'exams/[id]'}>{'subject'}</Translate>
                                    </TableCell>
                                    ...
                                    <TableCell align="left">
                                        <Translate root={'exams/[id]'}>{'no of questions'}</Translate>
                                    </TableCell>
                                    <TableCell align="left" />
                                    <TableCell align="left" />
                                </TableRow>
